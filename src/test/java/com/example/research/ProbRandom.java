...
/**
 * @ Author     ：zhangcx
 * @ Date       ：Created in 10:58 2019/10/9
 * @ Description：随机概率工具
 * @ Modified By：
 * @Version:
 */
public class ProbRandom {
    ...
    private void distribute() {
        ...
        if (updateFlag) {
            ...
            if (zeroOriginalCount == 0) {
                for (Map.Entry<Object, Integer> e : originalMap.entrySet()) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("countA " + countA +"--"+(countA/count));
        System.out.println("countB " + countB +"--"+(countB/count));
        System.out.println("countC " + countC +"--"+(countC/count));
    }
}
